...
cargo check --no-default-features --features "native, subxt, subxt_metadata",
...
cargo check --target wasm32-unknown-unknown --no-default-features --features "wasm, subxt, subxt_metadata"
