...
pub async fn tx_tests() -> Result<(), Error> {
	...
	// Bond Extra
	{
		let block = SignedExtrinsics::new(client.clone(), 1831776);
	...
	// Bond Extra #2
	{
		let block = SignedExtrinsics::new(client.clone(), 1831566);
	...
	// Bond Extra Other
	{
		let block = SignedExtrinsics::new(client.clone(), 202579);
	...
	// Chill
	{
		let block = SignedExtrinsics::new(client.clone(), 1729911);
	...
	// Claim Commission
	{
		let block = SignedExtrinsics::new(client.clone(), 1802972);
	...
	// Claim Payout
	{
		let block = SignedExtrinsics::new(client.clone(), 1831831);
	...
	// Claim Payout Other
	{
		let block = SignedExtrinsics::new(client.clone(), 535568);
	...
	// Create
	{
		let block = SignedExtrinsics::new(client.clone(), 182681);
	...
	// Create With Pool Id
	{
		let block = SignedExtrinsics::new(client.clone(), 481224);
	...
	// Join
	{
		let block = SignedExtrinsics::new(client.clone(), 1822288);
	...
	// Nominate
	{
		let block = SignedExtrinsics::new(client.clone(), 1808990);
	...
	{
		let block = SignedExtrinsics::new(client.clone(), 1827335);
	...
	{
		let block = SignedExtrinsics::new(client.clone(), 1827272);
	...
	{
		let block = SignedExtrinsics::new(client.clone(), 1716287);
	...
	// Set Commission #1
	{
		let block = SignedExtrinsics::new(client.clone(), 1181206);
	...
	// Set Commission #2
	{
		let block = SignedExtrinsics::new(client.clone(), 1056874);
	...
	{
		let block = SignedExtrinsics::new(client.clone(), 493706);
	...
	// Set Commission Max
	{
		let block = SignedExtrinsics::new(client.clone(), 472501);
	...
	// Set Metadata
	{
		let block = SignedExtrinsics::new(client.clone(), 182911);
	...
	// Set State #1
	{
		let block = SignedExtrinsics::new(client.clone(), 86141);
	...
	// Set State #2
	{
		let block = SignedExtrinsics::new(client.clone(), 337747);
	...
	// Unbond
	{
		let block = SignedExtrinsics::new(client.clone(), 1831014);
	...
	// Update Roles #1
	{
		let block = SignedExtrinsics::new(client.clone(), 694694);
	...
	// Update Roles #2
	{
		let block = SignedExtrinsics::new(client.clone(), 183031);
	...
	// Withdraw Unbonded
	{
		let block = SignedExtrinsics::new(client.clone(), 1832868);
