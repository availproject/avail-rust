...
use crate::{
	transaction_execute, transaction_execute_and_watch, transaction_execute_and_watch_finalization,
	transaction_execute_and_watch_inclusion, transaction_options, transaction_payment,
};

pub async fn run() -> Result<(), ClientError> {
	transaction_execute_and_watch_finalization::run().await?;
	transaction_execute_and_watch_inclusion::run().await?;
	transaction_execute_and_watch::run().await?;
