use avail_rust::{account::account_id_from_str, block::to_ascii, prelude::*, utils::new_h256_from_hex};
...
pub async fn run() -> Result<(), ClientError> {
	...
	let block_transactions = block.transaction_by_signer(account_id.clone());
