...
impl EventClient {
	...
	// Block Events
	pub async fn block_events(&self, at: H256) -> Result<Vec<Event>, RpcError> {
		use subxt_core::events::Events;
	...
	// Transaction Events
	pub async fn transaction_events(&self, tx_index: u32, at: H256) -> Result<Vec<Event>, RpcError> {
