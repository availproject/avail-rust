...
impl Client {
	...
	) -> Result<rpc::block::block_overview::Response, RpcError> {
	...
	) -> Result<rpc::block::block_data::Response, RpcError> {
	...
	pub async fn rpc_chain_get_block_hash(&self, block_height: Option<u32>) -> Result<Option<H256>, RpcError> {
