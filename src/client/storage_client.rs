...
impl StorageClient {
	...
	pub async fn fetch<'address, Addr>(&self, address: &Addr, at: H256) -> Result<Option<Addr::Target>, RpcError>
	where
	...
	pub async fn fetch_or_default<'address, Addr>(&self, address: &Addr, at: H256) -> Result<Addr::Target, RpcError>
	where
