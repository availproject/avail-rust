...
--derive-for-type avail_core::header::extension::v4::HeaderExtension=serde::Serialize  \
--derive-for-type avail_core::header::extension::v4::HeaderExtension=serde::Deserialize  \
--derive-for-type avail_core::header::extension::v4::HeaderExtension=Default \
...
--derive-for-type avail_core::data_lookup::v3_compact::CompactDataLookup=Default \
--derive-for-type avail_core::data_lookup::v3_compact::CompactDataLookup=serde::Serialize \
--derive-for-type avail_core::data_lookup::v3_compact::CompactDataLookup=serde::Deserialize \
--derive-for-type avail_core::data_lookup::v3_compact::DataLookupItem=serde::Serialize \
--derive-for-type avail_core::data_lookup::v3_compact::DataLookupItem=serde::Deserialize \
--derive-for-type avail_core::data_lookup::v4_compact::CompactDataLookup=Default \
--derive-for-type avail_core::data_lookup::v4_compact::CompactDataLookup=serde::Serialize \
--derive-for-type avail_core::data_lookup::v4_compact::CompactDataLookup=serde::Deserialize \
--derive-for-type avail_core::data_lookup::v4_compact::DataLookupItem=serde::Serialize \
--derive-for-type avail_core::data_lookup::v4_compact::DataLookupItem=serde::Deserialize \
