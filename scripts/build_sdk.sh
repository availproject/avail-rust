...
cargo check --no-default-features --features "native, tracing, mocks"

rustup target add wasm32-unknown-unknown
cargo check --target wasm32-unknown-unknown --no-default-features --features "wasm"
cargo check --target wasm32-unknown-unknown --no-default-features --features "wasm, tracing"
cargo check --target wasm32-unknown-unknown --no-default-features --features "wasm, tracing, mocks"
